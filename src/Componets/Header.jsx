...
const [openBar, setOpenBar] = useState(false);
  ...
  return (
    ...
    <div className=' fixed top-0 right-0 left-0 z-50 bg-[#000000] text-white font-serif '>
...
<nav>
        ...
        Contact
            ...
            {/* Mobile Menu */}
            <div
                className={`fixed top-0 right-0 bg-black w-[200px] h-full transform ${openBar ? "translate-x-0" : "translate-x-full"
