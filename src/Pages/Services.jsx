...
const Services = () => {
    return (
        <div >
            {/* div big */}
            <div className=' container mx-auto text-sm pt-[60px] pb-10'>
                {/* div one */}
                ...
                <div className='text-center items-center  '>
                    ...
                    <div className=''>
                        ...
                        <div className=' px-10  rounded-lg shadow-md mb-10  h-[320px]    transition-transform duration-300 hover:scale-90'>
